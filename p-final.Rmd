...
# (note:- Decision Tree draw in apendix fig.1)
...
bp<-barplot(all_accuracy,main="Accuracy table",ylim = c(0,1),names.arg = c("rpart","RF","GBM","LDA"),col = c("lightblue", "mistyrose", "lavender","skyblue"),ylab = "Accuracy of the model",xlab = "Model Name")
